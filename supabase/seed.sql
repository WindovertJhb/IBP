...
-- team names and current sales staff with Brian, then edit this file (or
-- just enter it through the app's Sales People / Teams tabs instead —
...
-- Starter booking statuses — add/edit/reorder freely from the Status tab.
insert into statuses (name, color) values
  ('Pre-Programmed', '#0d6efd'),
  ('Date Confirmed', '#198754');
